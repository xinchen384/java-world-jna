...
public class HelloWorld {
  ...
  */
  ...
  //https://github.com/openjdk-mirror/jdk7u-jdk/blob/f4d80957e89a19a29bb9f9807d2a28351ed7f7df/src/share/classes/sun/nio/ch/IOUtil.java
  ...
  private int readIntoNativeBuffer( ByteBuffer bb, long position )
    {
        int pos = bb.position();
        int lim = bb.limit();
        assert (pos <= lim);
  ...
  static public void main(String argv[]) throws IOException{
        ...
        ByteBuffer r = ByteBuffer.allocate(20);
        jtest.read(r, 0);
        if (r.hasRemaining()){
          System.out.println(" has remaining!!!! still can fit in => Error!!!");
        }else {
          System.out.println(" it is full ");
        }
        System.out.println("read from C Channel: " + new String(r.array()));
        System.out.println("the size of C Channel: " + jtest.size());
